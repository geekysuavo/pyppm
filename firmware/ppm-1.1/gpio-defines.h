...
#define GPIO_LDOEN_DDR  DDRC
#define GPIO_LDOEN_PORT PORTC
#define GPIO_LDOEN_PIN  PORTC6
...
#define gpio_led_init() \
  GPIO_LED_DDR |= ((1 << GPIO_LED_PINA) | (1 << GPIO_LED_PINB)); \
  gpio_led_comm_off (); \
  gpio_led_adc_off ();
