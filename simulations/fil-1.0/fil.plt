...
set multiplot layout 3,1 title 'fil response'
...
plot 'fil-meas.txt' u 1:(20*log10($3/$2)) \
  w p pt 5 lt rgb '#ffbbbb' t 'G(w) (Actual)',\
     'fil-sim.txt' u 2:(20*log10($5/$3)) \
...
plot 'fil-meas.txt' u 1:($4) \
  w p pt 5 lt rgb '#bbbbff' t 'phi(w) (Actual)',\
     'fil-sim.txt' u 2:(($4-$6)*180/pi) \
